...
CollabClient.prototype.dispatchForeignEdit = function(edit) {
  ...
  this.connection.pendingEdits.forEach(function(pendingEdit) {
  ...
  this.connection.pendingEdits.forEach(function(pendingEdit, i) {
    var cs = Changeset.unpack(pendingEdit.diff)
...
CollabClient.prototype.createEdit = function(changeset) {
  var latestEdit;
  if(!latestEdit) latestEdit = this.connection.pendingEdits.length? this.connection.pendingEdits[this.connection.pendingEdits.length-1] : null
